...
#        return u
    ...
    def makeEntityGraph(self, entities, interactions, entityToDuplicates=None):
        ...
        params:
            ...
            interactions: ALL original interactions
            entityToDuplicates: dict. key is a mergedEntity(Entity Element), value is a list of all duplicated entities of this mergedEntity(Entity Element)
        """
        graph = Graph()
        ...
        # initialize a helper map, this is a dict of dict
        # interactionMap[e1][e2] is the interactions between e1 and e2
        interactionMap = {}
...
#        return rv
    ...
    def mapInteractions(self, entityElements, interactionElements, verbose=False):
        ...
        for interaction in self.interactions:
            ...
            if (not self.entitiesById.has_key(interaction.get("e1"))): #and self.entitiesById.has_key(interaction.get("e2")):
            ...
            if (not self.entitiesById.has_key(interaction.get("e2"))): #and self.entitiesById.has_key(interaction.get("e1")):
            ...
            if self.entitiesById.has_key(interaction.get("e1")) and self.entitiesById.has_key(interaction.get("e2")):
                token1 = self.entityHeadTokenByEntity[self.entitiesById[interaction.get("e1")]]
                token2 = self.entityHeadTokenByEntity[self.entitiesById[interaction.get("e2")]]
            # else:
            #     token1 = self.entityHeadTokenByEntity[self.entitiesById[self.entitiesById.keys()[0]]]
